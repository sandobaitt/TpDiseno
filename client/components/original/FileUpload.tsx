...
function FileUpload() {
    ...
    return (
        <div
            className={`flex flex-col justify-center items-center px-5 py-8 rounded-xl border-2 border-dashed cursor-pointer bg-zinc-800 ${dragActive ? "border-lime-400" : "border-neutral-700"
                }`}
