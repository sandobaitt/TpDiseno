    ...
    <div className="flex flex-col min-h-screen bg-squat-dark font-inter">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-squat-dark/90 backdrop-blur-md shadow-[0_20px_40px_0_rgba(0,0,0,0.40)]">
        <div className="max-w-[1280px] mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <Link to="/secretaria" className="font-jakarta font-bold text-base text-squat-ink px-6 py-2 rounded-[6px] bg-squat-green shadow-[0_10px_20px_0_rgba(149,253,0,0.20)] hover:brightness-105 transition-all">
            Secretaria
          </Link>
        </div>
      </header>
